...
import CollectTable, { CollectTransaction } from "../collection-history/components/CollectTable";
  ...
  const handleSearch = () => {
    const filtered = transactions.filter(
      (transaction) =>
        ...
        `${transaction.date} ${transaction.store} ${transaction.phoneNumber} ${transaction.address} ${transaction.volume} ${transaction.request}`
          .toLowerCase()
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="그린다 플랫폼 관리자의 수거 내역 리스트 페이지 입니다." />
